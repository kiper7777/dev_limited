...
$stmt = mysqli_prepare($conn, "
    INSERT INTO leads (user_id, source, full_name, email, company_name, budget_range, message)
    VALUES (?, 'contact_form', ?, ?, ?, ?, ?)
");
mysqli_stmt_bind_param($stmt, "isssss", $userId, $name, $email, $company, $budget, $message);
